...
function [QE] = profile_latent_heat_flux(z_r, phi_m, Ri, ro_air, c)
...
function Ri = profile_richardson(z1,z2,T1,T2,q1,q2,u1,u2,p,c)
...
function [QH] = profile_sensible_heat_flux (z_r,phi_m, Ri, ro_air,c)
...
function phi_m = profile_stability(Ri)
