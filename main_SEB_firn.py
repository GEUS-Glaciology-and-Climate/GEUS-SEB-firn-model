...
df_surface['L'], df_surface['LHF'], df_surface['SHF'], df_surface['theta_2m'], \
       df_surface['q_2m'], df_surface['ws_10m'], df_surface['Re'], \
           df_surface['melt_mweq'], df_surface['sublimation_mweq'], \
               snowc, snic,  slwc, T_ice,  zrfrz, \
        rhofirn, zsupimp,  dgrain,  zrogl,  Tsurf,  \
        grndc, grndd,  pgrndcapc, pgrndhflx, dH_comp,  \
        snowbkt, compaction = seb.HHsubsurf(df_aws, c)
