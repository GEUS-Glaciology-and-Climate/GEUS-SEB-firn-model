...
def run_GEUS_model(site, filename):
    ...
    c.Tdeep = df_info.loc[df_info['station name'] == c.station, 'deep firn temperature (degC)'].values[0] + 273.15
    ...
    rhofirn, snowc, snic, slwc, dgrain, tsoil, grndc, grndd, compaction, \
...
if __name__ == "__main__":
    site_list = ['CEN', 'FA'] #['EGP', 'DYE-2','CP1','Saddle', 'Summit', 'KAN_U', 'NASA-SE']
